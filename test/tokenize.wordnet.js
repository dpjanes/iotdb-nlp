...
describe("tokenize.wordnet", function() {
    const _test = _.promise((self, done) => {
        const FOLDER = "tokenize.wordnet"

        _.promise(self)
            .then(_util.read_yaml("tokenize.syntax.aws", self.filename, "tokens"))
            .then(nlp.tokenize.wordnet)

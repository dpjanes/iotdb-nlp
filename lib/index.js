...
module.exports = Object.assign(
    ...
    require("./checkpoints"),
    {
        ...
        names: {
            extract: require("./names.extract").names_extract,
            contained: require("./names.contained").names_contained,
            join: require("./names.join").names_join,
        },
        organizations: {
            extract: require("./organizations.extract").organizations_extract,
        },
    },
    require("./normalize"),
    {}
